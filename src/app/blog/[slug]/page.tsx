import { UpperBlobIcon } from '@/app/(icons)'
...
const Blog = () => {
    return (
        <Section className='relative lg:px-24 flex justify-start  pt-20'>
            ...
            <div className='z-10 pt-32 w-full flex flex-col items-center md:px-20'>
                <div className='md:max-w-[50vw]'>
                    <h1 className='text-3xl text-secondary font-extrabold'>{'How to sell the products on Company: learn the art of selling'}</h1>
                </div>
                ...
                <div className='md:max-w-[50vw] h-full md:max-h-[50vh] w-full md:flex'>
                    <Image src={'/(assets)/stationary.jpg'} alt='' className='w-full rounded-xl' height={100} width={400} priority />
                </div>
                <div className='py-10 md:max-w-[50vw]'>
                ...
                <div className='p-4 bg-gray-100 rounded-md flex flex-row'>
                    <Image src={'/(assets)/cosmetics.png'} height={100} width={100} alt='' className='h-16 w-16 rounded-full' />
                    <div className='px-4'>
                ...
                <div className='w-full'>
                    ...
                    <div className="mx-auto mt-16 py-10 flex md:overflow-x-auto max-w-2xl lg:flex-row flex-col gap-x-8 gap-y-20 lg:mx-0 lg:max-w-6xl lg:grid-cols-3">
                        {posts.map((post) => (
