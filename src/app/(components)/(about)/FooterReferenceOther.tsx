        ...
        <Section className='flex py-20 flex-col justify-center place-items-center'>
            <div className='bg-[#E5F8FF] rounded-md text-black p-4 md:p-8 w-full md:max-w-[60vw]'>
                ...
                <div className='flex py-4 gap-4 text-white flex-row'>
                    <button className='bg-main font-bold text-[12px] md:text-[14px] rounded-md py-3 px-6'>Contact Us</button>
                    <button className='bg-transparent text-main border-2 border-main flex justify-center place-items-center text-[12px] md:text-[14px] gap-4 font-bold rounded-md py-3 px-6'><span><WhatsapIcon /></span>Contact on Whatsap</button>
                </div>
            </div>
        </Section>
    )
